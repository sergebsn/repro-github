...
CREATE TABLE `likes` (
  ...
  KEY `fk_likes_profiles1_idx` (`profiles_users_id`),
  ...
  CONSTRAINT `fk_likes_profiles1` FOREIGN KEY (`profiles_users_id`) REFERENCES `profiles` (`users_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `likes_type` (
  ...
  KEY `fk_likes_type_likes1_idx` (`likes_id`),
  CONSTRAINT `fk_likes_type_likes1` FOREIGN KEY (`likes_id`) REFERENCES `likes` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `messages` (
  ...
  `from_users_id` int unsigned NOT NULL,
  `to_users_id` int unsigned NOT NULL,
  `media_id1` int unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_messages_users1_idx` (`from_users_id`),
  KEY `fk_messages_users2_idx` (`to_users_id`),
  KEY `fk_messages_media1_idx` (`media_id1`),
  CONSTRAINT `fk_messages_media1` FOREIGN KEY (`media_id1`) REFERENCES `media` (`id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='media_id';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-01-27 21:22:24
